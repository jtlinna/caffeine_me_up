...
// -1 Invalid group ID
// -2 Invalid group member ID
// -3 Only members with manage rights are allowed to change group member roles
// -200 Invalid request / internal error
exports.removeGroupMember = functions
    .region('europe-west2')
    .https
    .onCall(async (data, context) => {
        ...
        const groupMemberIdx = groupData.members.findIndex((member) => member.userId === groupMemberId && member.role !== userRoleOwner);
        ...
        groupData.members.splice(groupMemberIdx, 1);
        userData.groups.splice(userDataGroupIdx, 1);
